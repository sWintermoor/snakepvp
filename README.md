...
```
cd existing_repo
git remote add origin https://git.informatik.uni-hamburg.de/sav/fpprak24/racket-rookies/snake-pvp.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.informatik.uni-hamburg.de/sav/fpprak24/racket-rookies/snake-pvp/-/settings/integrations)
